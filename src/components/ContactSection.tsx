...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-fifa-blue to-fifa-dark relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-white/70 max-w-2xl mx-auto mt-4">
            Ready to start a new project or just want to connect?
          </p>
        </div>
          ...
          <div className="fifa-card p-6">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="bg-fifa-dark p-3 rounded-lg">
                  <Mail className="h-5 w-5 text-fifa-teal" />
                </div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="bg-fifa-dark p-3 rounded-lg">
                  <Phone className="h-5 w-5 text-fifa-teal" />
                </div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="bg-fifa-dark p-3 rounded-lg">
                  <MapPin className="h-5 w-5 text-fifa-teal" />
                </div>
                <div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-fifa-dark p-3 rounded-lg hover:bg-fifa-dark/80 transition-colors">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  className="bg-fifa-dark border-fifa-dark/80 text-white"
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                <label htmlFor="subject" className="text-white/80 block">Subject</label>
                <Input 
                  id="subject" 
                  placeholder="Subject" 
                  className="bg-fifa-dark border-fifa-dark/80 text-white"
              ...
              <div className="space-y-2">
                ...
                <Textarea 
                  ...
                  className="bg-fifa-dark border-fifa-dark/80 text-white min-h-[120px]"
                  required
                />
              </div>
              
              <Button type="submit" className="w-full bg-fifa-teal text-fifa-dark hover:bg-fifa-teal/90">
